...
import { queryHuggingFace } from './api';


export class BugFixPanel {
  public static currentPanel: BugFixPanel | undefined;
  ...
  private async _getActiveEditorWithFocus(): Promise<vscode.TextEditor | null> {
    ...
    this._panel.webview.onDidReceiveMessage(
      async (message) => {     
        if (message.command === 'checkBugs') {
            ...
            const result = await queryHuggingFace(code);
